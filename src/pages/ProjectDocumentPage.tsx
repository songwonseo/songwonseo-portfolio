  ...
  return (
    <main className="document-page">
      <section className="document-header">
        <div className="container">
          ...
          <div className="document-actions">
            ...
            <a className="button button--secondary" href={project.documentUrl} target="_blank" rel="noreferrer">
              <ExternalLink /> 새 탭에서 열기
            </a>
            <a className="button button--primary" href={project.documentUrl} download>
              <Download /> PDF 다운로드
            </a>
          </div>
        </div>
      ...
      <section className="document-viewer container" aria-label={`${project.title} 기술명세서 PDF`}>
        <object data={project.documentUrl} type="application/pdf">
          <div className="document-fallback">
            <p>이 브라우저에서는 PDF 미리보기를 지원하지 않습니다.</p>
            <a className="button button--primary" href={project.documentUrl} target="_blank" rel="noreferrer">
              PDF 직접 열기
            </a>
          </div>
        </object>
