...
export const projects: Project[] = [
  {
    ...
    status: "Completed",
    description: [
      "혼자 계획을 기록하는 일정 관리가 아니라, 같은 지역과 관심사를 가진 사용자들이 플래너즈를 만들고 가입해 함께 계획을 완성하도록 기획했습니다.",
      "플래너즈 탐색과 가입부터 대화, 일정 조율, 일정 공유까지 하나의 서비스 안에서 자연스럽게 이어집니다.",
      "실시간 채팅과 시각적인 시간표 편집을 결합해 대화 중 나온 의견을 곧바로 공동 일정에 반영할 수 있습니다.",
    ],
    overview: [
  ...
  },
  {
    ...
    screenshots: [
      ...
      },
      {
        src: "",
        title: "그룹 퀘스트 화면",
        description: "다른 사용자와 함께 목표에 도전하는 협동 퀘스트 화면입니다.",
      },
      {
        src: "",
        title: "친구 화면",
        description: "친구의 프로필과 성장 정보를 확인하고 비교하는 소셜 화면입니다.",
      },
      {
        src: "",
        title: "마이페이지",
        description: "프로필, 성장 기록, 도감과 계정 정보를 관리하는 개인 공간입니다.",
      },
    ],
    troubles: [
      {
